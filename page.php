...
<body>
	<?php
		...
		//Identification du type de personne
		...
		//Modification le nom en fonction de la personne
	...
	<?php
		if ($currentUser == "professeur") {
			...
			if(isset($_POST["AfficheNote"])){
				...
				if($sql->rowCount()!=0){
					...
					echo '<table id="tableEtudiant" style="width: 300px">
							...
							<tbody>';
					//Vérification si l'étudiant possède des notes
			...
			if(isset($_POST["AfficheNote2"])){
				...
				//Si aucune demande, on propose le form
				echo '<form method="post" action="#">
							<fieldset style="width:350px;margin:0 auto">
								<legend>Note étudiants et matières</legend>
	...
	<?php 
		echo '<a href="logout.php"><p style="text-align: center">Déconnection</p></a>';
	?>
